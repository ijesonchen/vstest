...
#ifndef PROTOBUF_RouteGuide_2eproto__INCLUDED
#define PROTOBUF_RouteGuide_2eproto__INCLUDED
...
class Point : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:routeguide.Point) */ {
 ...
 private:
  ...
  friend struct protobuf_RouteGuide_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
#if LANG_CXX11
inline void RouteSummary::set_note(::std::string&& value) {
...
#endif
inline void RouteSummary::set_note(const char* value) {
  GOOGLE_DCHECK(value != NULL);
...
inline void RouteSummary::set_note(const char* value, size_t size) {
...
inline ::std::string* RouteSummary::mutable_note() {
...
inline ::std::string* RouteSummary::release_note() {
...
inline void RouteSummary::set_allocated_note(::std::string* note) {
  if (note != NULL) {
...
#endif  // PROTOBUF_RouteGuide_2eproto__INCLUDED
