...
namespace protobuf_RouteGuide_2eproto {
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RouteSummary, note_),
};
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "RouteGuide.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "\010distance\030\002 \001(\005\022\024\n\014elapsed_time\030\003 \001(\005\022\014\n"
      "\004note\030\004 \001(\t2\205\002\n\nRouteGuide\0226\n\nGetFeature"
      "\022\021.routeguide.Point\032\023.routeguide.Feature"
      "\"\000\022>\n\014ListFeatures\022\025.routeguide.Rectangl"
      "e\032\023.routeguide.Feature\"\0000\001\022>\n\013RecordRout"
      "e\022\021.routeguide.Point\032\030.routeguide.RouteS"
      "ummary\"\000(\001\022\?\n\tRouteChat\022\025.routeguide.Rou"
      "teNote\032\025.routeguide.RouteNote\"\000(\0010\001b\006pro"
      "to3"
  };
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
      descriptor, 643);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "RouteGuide.proto", &protobuf_RegisterTypes);
}
} // anonymous namespace
...
Point::Point()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_RouteGuide_2eproto::InitDefaults();
  }
  SharedCtor();
...
const ::google::protobuf::Descriptor* Point::descriptor() {
  protobuf_RouteGuide_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_RouteGuide_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
::google::protobuf::Metadata Point::GetMetadata() const {
  protobuf_RouteGuide_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_RouteGuide_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
const int RouteSummary::kNoteFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
...
void RouteSummary::SerializeWithCachedSizes(
  ...
  if (this->elapsed_time() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(3, this->elapsed_time(), output);
  }
...
::google::protobuf::uint8* RouteSummary::InternalSerializeWithCachedSizesToArray(
  ...
  // int32 elapsed_time = 3;
  if (this->elapsed_time() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(3, this->elapsed_time(), target);
  }
...
// string note = 4;
void RouteSummary::clear_note() {
  note_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
const ::std::string& RouteSummary::note() const {
  // @@protoc_insertion_point(field_get:routeguide.RouteSummary.note)
  return note_.GetNoArena();
}
void RouteSummary::set_note(const ::std::string& value) {
  
  note_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:routeguide.RouteSummary.note)
}
#if LANG_CXX11
void RouteSummary::set_note(::std::string&& value) {
  
  note_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:routeguide.RouteSummary.note)
}
#endif
void RouteSummary::set_note(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  note_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:routeguide.RouteSummary.note)
}
void RouteSummary::set_note(const char* value, size_t size) {
  
  note_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:routeguide.RouteSummary.note)
}
::std::string* RouteSummary::mutable_note() {
  
  // @@protoc_insertion_point(field_mutable:routeguide.RouteSummary.note)
  return note_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
::std::string* RouteSummary::release_note() {
  // @@protoc_insertion_point(field_release:routeguide.RouteSummary.note)
  
  return note_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
void RouteSummary::set_allocated_note(::std::string* note) {
  if (note != NULL) {
  ...
  // @@protoc_insertion_point(field_set_allocated:routeguide.RouteSummary.note)
}
